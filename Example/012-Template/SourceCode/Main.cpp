...
int main()
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	// 3. 난수 발생기의 이항 분포
	printf("이항 분포는 (사건이 발생한 횟수의 범위, 사건이 발생할 확률)이 필요해요.\n");

	// 시행 횟수 2000번에 50% 확률로 9번 사건이 발생한다고 가정했을 때의 난수를 구해요.
	// 게임으로 얘기하면 강화 횟수 2000번에 50% 확률로 강화가 9번 성공했을 때의 난수를 구해요.
	std::binomial_distribution<int32> BD_num(9);
	for (int32 i = 0; i < MAX_TRIAL_COUNT; ++i)
	{
