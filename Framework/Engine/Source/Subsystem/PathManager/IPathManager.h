...
public:
	...
	virtual const std::string& FrameworkRelativePath() const PURE_FUNC;
	virtual Uint32 FrameworkRelativePathStartPos() const PURE_FUNC;

	virtual const std::string& ClientAbsolutePath() const PURE_FUNC;
	virtual const std::string& ClientRelativePath() const PURE_FUNC;
	virtual Uint32 ClientRelativePathStartPos() const PURE_FUNC;
